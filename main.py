...
prompt = PromptTemplate.from_template(
    """
    Create a clever and humorous answer that is specifically related to '{input}'. 
    The answer should be original, light-hearted, and suitable for a general audience.
